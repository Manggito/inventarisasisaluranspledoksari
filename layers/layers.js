...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleRoads_2.setVisible(true);lyr_OpenTopoMap_3.setVisible(true);lyr_SUNGAI_4.setVisible(true);lyr_JALAN_5.setVisible(true);lyr_AREAFUNGSIONAL_6.setVisible(true);lyr_JalurPipa_7.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_8.setVisible(true);lyr_JENISSALURAN_9.setVisible(true);lyr_AREANOMENKLATUR_10.setVisible(true);lyr_BANGUNANNOMENKLATUR_11.setVisible(true);lyr_Tikungan_12.setVisible(true);lyr_Beda_Pasangan_13.setVisible(true);lyr_Gorong___Gorong_14.setVisible(true);lyr_Titik_Per_50_m_15.setVisible(true);lyr_BoxAlvaValve_16.setVisible(true);lyr_BoxGateValve_17.setVisible(true);lyr_Bangunan_Air_18.setVisible(true);lyr_Bangunan_Bagi_19.setVisible(true);lyr_Bangunan_Sadap_20.setVisible(true);lyr_Rumah_Pompa_21.setVisible(true);
...
lyr_KETERANGAN_KERUSAKAN_SALURAN_8.set('fieldImages', {'Id': 'Range', 'JENIS': 'TextEdit', 'KATEGORI': 'TextEdit', 'KETERANGAN': '', 'PANJANG': 'TextEdit', });
...
lyr_AREAFUNGSIONAL_6.set('fieldLabels', {'Id': 'hidden field', 'LUAS': 'inline label - visible with data', 'SATUAN': 'no label', 'PEMBAGIAN': 'no label', });
